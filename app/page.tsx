...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    const observerOptions = {
      root: null,
      rootMargin: '-10%', // Reduced margin to prevent early triggers
      threshold: 0.2 // Increased threshold for more deliberate triggers
    }
                            ...
                            const observer = new IntersectionObserver((entries) => {
                              entries.forEach((entry) => {
                                if (entry.isIntersecting) {
                                  ...
                                  const statIndex = parseInt(target.getAttribute('data-index') || '0');
          ...
          <div className="max-w-4xl mx-auto">
            <FadeSection>
              ...
              <p className="text-gray-200 text-lg leading-relaxed">
                ...
                Thank you to the team @ <a 
                  href="https://bugsnyu.com" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="font-medium text-white hover:text-purple-400 transition-colors relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 hover:after:w-full after:bg-purple-400 after:transition-all"
                >
                  BUGS
                </a> for providing{' '}
                <a 
