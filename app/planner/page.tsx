...
type AppleColor = typeof APPLE_COLORS[number]
...
const getColorForCourse = (code: string) => {
  ...
  return APPLE_COLORS[sum % APPLE_COLORS.length]
}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-8">
            <h1 className="text-3xl font-bold">
              My <span className="bg-[#007AFF] text-white px-2 py-1 rounded-md">Planner</span>
            </h1>
